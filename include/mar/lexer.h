...
typedef enum {
    ...
    TOK_STRING,     /* FEATURE 1 */
    /* control flow */
    TOK_IF, TOK_ELSE, TOK_WHILE, TOK_FOR, TOK_IN, TOK_RANGE,
    TOK_SWITCH, TOK_CASE, TOK_DEFAULT,
    TOK_RETURN, TOK_BREAK,
    /* builtins */
    TOK_PRINT, TOK_TAKE, TOK_LEN,   /* FEATURE 1: len() */
    /* OOP */
    TOK_CLASS, TOK_NEW, TOK_EXTENDS,  /* FEATURE 4: extends */
    /* other */
    TOK_NULL,    /* FEATURE 5 */
    TOK_IMPORT,  /* FEATURE 2 */
    /* operators */
    ...
    /* special */
    TOK_EOF, TOK_UNKNOWN,
    TOK_PCT_ASSIGN   /* duplicate kept for compat */
} TokenKind;
